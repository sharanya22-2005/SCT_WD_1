  ...
  const timelineData: TimelineItem[] = [
    {
      id: 'exp-1',
      type: 'education',
      title: 'Bachelor of Engineering – Atria Institute of Technology',
      date: '2024 - 2028',
      description: 'Pursuing a Bachelor of Engineering in Information Science and Engineering. Maintaining a current CGPA of 9.55 / 10 (till 1st Year) with a high focus on core data structures, algorithms, object-oriented programming, and interactive web development.',
      tags: ['ISE', 'Atria Tech', '9.55 CGPA', 'OOP', 'DSA'],
    },
    {
      id: 'exp-2',
      type: 'education',
      title: 'Pre-University Course (12th) – Diana Independent PU College',
      date: '2022 - 2024',
      description: 'Completed Pre-University education focusing on core science and computer subjects, graduating with an aggregate score of 90.5%.',
      tags: ['PUC', '12th Grade', 'Science Stream', '90.5%'],
    },
    {
      id: 'exp-3',
      type: 'education',
      title: 'Secondary School Leaving Certificate (10th) – St. Teresa’s Girls High School',
      date: '2022',
      description: 'Graduated with a stellar aggregate score of 92.32%, showcasing strong academic performance and fundamental knowledge.',
      tags: ['SSLC', '10th Grade', '92.32%'],
    },
  ];
